...
public class SampleAppTest {
    ...
    private void setUp() {
        ...
        if (platform.equals("ANDROID")) {
            ...
            capabilities.setCapability(MobileCapabilityType.DEVICE_NAME, "iPhone 8 Simulator (13.4)");
    ...
    public void textFieldTest() {
        ...
        assertEquals(pageView.getTextField(), "test", "Expected text value was not set");
    }
